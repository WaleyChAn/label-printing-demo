<template>
  <div class="demo-print">
    ...
    <div
      ...
      style="width: 300px; height: 165px; overflow: hidden; padding-top: 5px;"
    >
      ...
      >
        <dl style="margin: 0">
          ...
          <dd style="margin: 0; font-size: 26px; line-height: 26px; width: 90%; word-break: break-all;">
            CN234383
          </dd>
        </dl>
        <dl style="margin: 5px 0 0 0">
          <dt style="font-size: 14px; line-height: 14px">Purchasing Date:</dt>
          <dd style="margin: 0; font-size: 26px; line-height: 26px; width: 90%; word-break: break-all;">2023-08-23</dd>
        </dl>
        <dl style="margin: 5px 0 0 0">
          <dt style="font-size: 14px; line-height: 14px">Serial Number:</dt>
          <dd style="margin: 0; font-size: 26px; line-height: 26px; width: 90%; word-break: break-all;">5CG3332C32C17</dd>
        </dl>
      </div>
    </div>
  </div>
